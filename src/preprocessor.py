...
class Preprocessor:
    ...
    def preprocess_file(self, df: pd.DataFrame, 
                       sampling_rate: float = 93750) -> pd.DataFrame:
        """
    ...
    def preprocess_all(self, data: Dict[str, pd.DataFrame],
                      sampling_rate: float = 93750) -> Dict[str, pd.DataFrame]:
        """
    ...
    def _remove_outliers(self, signal_data: np.ndarray, 
    ...
    def _apply_filter(self, signal_data: np.ndarray, 
